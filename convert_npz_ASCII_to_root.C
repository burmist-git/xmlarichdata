...
namespace xmlarichdata{
  ...
  void convert_npz_ASCII_to_root( TString fileName = "./tmp/total_memory.dat"){
...
int main(int argc, char *argv[]){
  if(argc == 2){
    ...
    xmlarichdata::convert_npz_ASCII_to_root(fileName);
    return 0;
  }
  xmlarichdata::convert_npz_ASCII_to_root();
  return 0;
}
