...
mirror_reflection_vs_wavelength_bash(){

    #Run without generation of the dictionary and shared library. Please _note_ : no LinkDef.h file is needed.    
    #root -l -e 'gROOT->ProcessLine(".L mirror_reflection_vs_wavelength.C"); gROOT->ProcessLine("xmlarichdata::mirror_reflection_vs_wavelength()");'
    ...
    root -l -e 'gROOT->ProcessLine(".L libxmlarichdataDict.cxx"); gROOT->ProcessLine(".L libxmlarichdataDictLib.so"); gROOT->ProcessLine("xmlarichdata::mirror_reflection_vs_wavelength()");'
